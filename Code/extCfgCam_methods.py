...
def extractMethods():
    input_folder = os.path.join(os.getcwd(), 'bin\\header\\public/public_raw')
    output_file = os.path.join(os.getcwd(), 'bin\\header\\public/extCfgCam_methods.h')
    enum_output = os.path.join(os.getcwd(), 'bin\\header\\public/enums.txt')
    ...
    print("\n\n----------------------------------------------------")
    print(f"    Methods successfully created: {output_file}.")
    print("----------------------------------------------------\n")
...
def unifyEnums():
    ...
    methods_file = os.path.join(os.getcwd(), 'bin\\header\\public\\extCfgCam_methods.h')
...
def mergeHeaders():
    properties_path = os.path.join(os.getcwd(), 'bin\\header\\private\\extCfgCam_properties.h')
    methods_path = os.path.join(os.getcwd(), 'bin\\header\\public\\extCfgCam_methods.h')
    unified_path = os.path.join(os.getcwd(),'bin\\header\\config_camera.h')
